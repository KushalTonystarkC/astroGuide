const en: Record<string, string> = {
  ...
  show_degree_hint: "Planet degrees within each sign",
  chart_display_options: "Display",
  ...
  drishti_show_hint: "Tap planets to draw aspect lines on D1",
  hide_outer: "Hide Outer Planets",
  hide_outer_hint: "Uranus, Neptune, and Pluto",
  drishti_weak: "Weak",
  drishti_medium: "Medium",
  drishti_strong: "Strong",
  drishti_full: "Full",
  drishti_hint: "Tap any planet or house in the chart for details",
  drishti_aspect_hint: "Tap a planet to view its aspects · tap again to clear",
  col_planet: "Planet",
  col_time: "Time",
  col_result: "Result",
