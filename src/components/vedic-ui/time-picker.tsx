...
import { Popover, PopoverContent, PopoverTrigger } from "@/components/vedic-ui/popover";
import { useAstro } from "@/i18n/astro";
import { formatHHMM, meridiemLabels } from "@/lib/vedic/format";
            ...
            {(["AM", "PM"] as const).map((p) => (
              <button
                ...
                className={cn(
                  ...
                  period === p ? "bg-saffron text-primary-foreground" : "text-ink hover:bg-saffron/10",
                )}
              >
                {periodLabel(p)}
              </button>
          ...
          return (
            <button
              ...
              className={cn(
                ...
                active ? "bg-saffron text-primary-foreground font-semibold" : "text-ink hover:bg-saffron/10",
              )}
            >
              {format(v)}
            </button>
