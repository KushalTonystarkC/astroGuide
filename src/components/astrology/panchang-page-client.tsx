...
import { CitySearch } from "@/components/astrology/vedic-city-search";
...
import { DatePicker } from "@/components/vedic-ui/date-picker";
...
import { calculateChart, fetchPanchang, reverseGeocode } from "@/lib/vedic/api";
import {
  formatTime,
  formatTimeWithDate,
  formatLongDate,
...
import type { ChartData, LocationChoice, PanchangData, TransitItem } from "@/types/vedic-api";
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5">
                    <div className="md:col-span-1 space-y-3 max-w-xs mx-auto md:mx-0 md:max-w-none">
                      <div className="space-y-3">
                        ...
                        />
                        <ChartDisplayOptions
                          showDegrees={chartStyle !== "west" ? showDegrees : undefined}
                          onShowDegreesChange={chartStyle !== "west" ? onShowDegrees : undefined}
                          hideOuter={hideOuter}
                          onHideOuterChange={onHideOuter}
                          testIdPrefix="lagna"
                        />
                      </div>
